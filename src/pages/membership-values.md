...
Every relationship has friction sometimes. Here's how we handle it, whichever direction it goes.

If you ever feel we've fallen short of this promise, tell us. We'll listen, take it seriously, and do what we can to make it right.

If we ever have a concern about how we're being treated, or about the working relationship, we'll do the same: explain the concern clearly, and give it a real chance to get better.

We lead with kindness, grace, and forgiveness. Genuine mistakes and bad days don't end a membership.

Repeated disrespect, bullying, or a breakdown of trust that can't be resolved, does. If that happens, here's what ending a membership actually looks like:

1. We explain the concern, clearly and respectfully.
2. Wherever appropriate, we give it a real chance to be corrected.
3. If it's still not working, we stop billing and agree on an end date. No games, no runaround.
4. Any outstanding work gets finished or fairly reconciled.
5. We give you what you reasonably need to transition elsewhere.

This isn't about punishment on either side. It's about protecting a relationship that only works when both of us are treating each other well, and parting ways cleanly when it doesn't.
